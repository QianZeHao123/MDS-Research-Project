...
box_combine = ggplot(box) +
  ...
  labs(
    ...
    subtitle = "When the proportion of Influencers fixed to 0.1"
  ) +
  theme_light() +
  theme(
    plot.title = element_text(face = "bold", hjust = 0.5),
...
```{r}
ggsave("./pic_same_inf_prop_research/box_combine.png",
       plot = box_combine,
       device = "png",
       height = 8,
       width = 15)

ggsave("./pic_same_inf_prop_research/box_combine.svg",
       plot = box_combine,
       device = "svg",
       height = 8,
       width = 15)

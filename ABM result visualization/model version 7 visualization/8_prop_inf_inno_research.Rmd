...
```{r}
library(data.table)
simulation6_results = fread("./simulation6.csv")
```
...
ggsave("./pic_prop_inno_inf_research/step_to_25.png",
       plot = step_to_25,
       device = "png",
       height = 6,
       width = 8)
...
ggsave("./pic_prop_inno_inf_research/step_to_50.png",
       plot = step_to_50,
       device = "png",
       height = 6,
       width = 8)
...
ggsave("./pic_prop_inno_inf_research/step_to_75.png",
       plot = step_to_75,
       device = "png",
       height = 6,
       width = 8)

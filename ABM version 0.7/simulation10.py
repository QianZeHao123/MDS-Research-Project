"""
Simulation 10: Keep the same proportion of influencers
- N = 1000
- p = 0.01
- q = 0.3
...
def run_simulation(agent_proportion):
    ...
    output_file = f'./report/simulation10_proportion_{proportion_str}.csv'
...
def combine_csv_files(file_list):
    ...
    combined_df.to_csv('./report/simulation10.csv', index=False)

"""
Simulation 8: Change q and keep other parameters constant
- N = 1000
- p = 0.02
...
def run_simulation(q_value):
    ...
    output_file = f'./report/simulation8_q_{q_value}.csv'
...
def combine_csv_files(file_list):
    ...
    combined_df.to_csv('./report/simulation8.csv', index=False)

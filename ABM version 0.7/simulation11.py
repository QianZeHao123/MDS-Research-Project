"""
Simulation 11: Change the proportion of innovators and p
- N = 1000
...
def run_simulation(p_value, agent_proportion):
    ...
    output_file = f'./report/simulation11_p_{p_value}_proportion_{proportion_str}.csv'
...
def combine_csv_files(file_list):
    ...
    combined_df.to_csv('./report/simulation11.csv', index=False)

"""
Simulation 9: Keep the same proportion of innovators
- N = 1000
- p = 0.01
...
def run_simulation(agent_proportion):
    ...
    output_file = f'./report/simulation9_proportion_{proportion_str}.csv'
...
def combine_csv_files(file_list):
    ...
    combined_df.to_csv('./report/simulation9.csv', index=False)
